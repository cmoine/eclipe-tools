...
//	public static final String PLUGIN_ID = "org.springsource.ide.eclipse.quicksearch"; //$NON-NLS-1$
	...
	// The shared instance
	private static QuickSearchActivator plugin=new QuickSearchActivator();
...
//	}
	...
	public QuickSearchPreferences getPreferences() {
		if (prefs==null) {
			prefs = new QuickSearchPreferences(InstanceScope.INSTANCE.getNode(Activator.PLUGIN_ID));
		}
		return prefs;
	}
